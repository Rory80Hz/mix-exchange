...
(function() {
	...
	var soundcloud = window.soundcloud = {
		...
		_redispatch: function(eventType, flashId, data) {
			var playerNode, lsnrs = this._listeners[eventType] || [],
...
(function($) {
	...
	var apiKey, didAutoPlay = false,
		players = [],
		updates = {},
		currentUrl, loadTracksData = function($player, links, key) {
			var index = 0,
				playerObj = {
					node: $player,
					tracks: []
	...
	$.scPlayer = function(options, node) {
		...
		$player.find('.sc-controls').append('<a href="#play" class="sc-play">Play</a> <a href="#pause" class="sc-pause hidden">Pause</a>').end().append('<a href="#info" class="sc-info-toggle">Info</a>').append('<div class="sc-scrubber"></div>').find('.sc-scrubber').append('<div class="sc-volume-slider"><span class="sc-volume-status" style="width:' + soundVolume + '%"></span></div>').append('<div class="sc-time-span"><div class="sc-waveform-container"></div><div class="sc-buffer"></div><div class="sc-played"></div></div>').append();
		...
		$player.bind('onTrackDataLoaded.scPlayer', function(event) {
			...
			$.each(tracks, function(index, track) {
				...
				$('<li><h4><a href="' + track.permalink_url + '">' + track.title + '</a></h4><span class="sc-track-artist"> By ' + track.user.username + '</span><span class="sc-track-duration"><div class="sc-time-indicators"><span class="sc-position"></span> | <span class="sc-duration"></span></div></span></li>').data('sc-track', {
					id: index
